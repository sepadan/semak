...
- `index.html` menambah nombor versi pada `src/App.html` (contoh `?v=56`) supaya
...
- Deployment 56 mengecilkan muatan awal kepada ringkasan dashboard, melengkapkan
...
|---|---|---:|---|---|---|
| 2026-08-21 | `HEAD` | 56 | Paparkan ringkasan asas tanpa menunggu analisis pada cache kosong; analisis penuh di latar menyediakan cache semua kelas+Status; betulkan bacaan `kelasInfo` berbentuk objek | Sintaks dan unit lulus; live baca-sahaja: muatan awal 1.98s, analisis latar 7.27s, Isi Markah 1.29s, Status 1.66s; deployment 56 pada ID sama | Tiada |
